/**
 * Email-verification email. Self-contained, responsive HTML (tables + inline
 * styles for broad email-client support). Placeholders: {{name}}, {{url}}.
 */
...
<head>
  ...
  <title>Verify your stockMania email</title>
</head>
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background-color:#12141f;border:1px solid #242838;border-radius:16px;overflow:hidden;">
          <tr>
            <td style="padding:32px 32px 8px 32px;">
              ...
              <h1 style="margin:24px 0 0 0;color:#f5f7fb;font-size:22px;font-weight:700;">Verify your email</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:8px 32px 0 32px;">
              <p style="margin:0 0 16px 0;color:#c3c9d6;font-size:14px;line-height:22px;">
                Hi {{name}}, welcome to stockMania! Please confirm your email address
                to activate your account. Click the button below to verify.
              </p>
            </td>
          </tr>
          <tr>
